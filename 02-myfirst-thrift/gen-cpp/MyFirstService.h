...
class MyFirstServiceClient : virtual public MyFirstServiceIf {
 public:
  MyFirstServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  MyFirstServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class MyFirstServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 protected:
  boost::shared_ptr<MyFirstServiceIf> iface_;
  virtual bool dispatchCall(::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid, void* callContext);
 private:
  typedef  void (MyFirstServiceProcessor::*ProcessFunction)(int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*, void*);
 ...
 public:
  MyFirstServiceProcessor(boost::shared_ptr<MyFirstServiceIf> iface) :
    iface_(iface) {
    processMap_["log"] = &MyFirstServiceProcessor::process_log;
    processMap_["multiply"] = &MyFirstServiceProcessor::process_multiply;
    processMap_["get_log_size"] = &MyFirstServiceProcessor::process_get_log_size;
  }

  virtual ~MyFirstServiceProcessor() {}
};

class MyFirstServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  MyFirstServiceProcessorFactory(const ::boost::shared_ptr< MyFirstServiceIfFactory >& handlerFactory) :
...
class MyFirstServiceConcurrentClient : virtual public MyFirstServiceIf {
 public:
  MyFirstServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  MyFirstServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
