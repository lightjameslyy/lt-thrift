...
class MyFirstServiceIf {
 public:
  ...
  virtual double divide(const double number1, const double number2) = 0;
...
class MyFirstServiceNull : virtual public MyFirstServiceIf {
 public:
  ...
  double divide(const double /* number1 */, const double /* number2 */) {
...
typedef struct _MyFirstService_divide_args__isset {
  _MyFirstService_divide_args__isset() : number1(false), number2(false) {}
  bool number1 :1;
  bool number2 :1;
} _MyFirstService_divide_args__isset;

class MyFirstService_divide_args {
 public:

  MyFirstService_divide_args(const MyFirstService_divide_args&);
  MyFirstService_divide_args& operator=(const MyFirstService_divide_args&);
  MyFirstService_divide_args() : number1(0), number2(0) {
  }

  virtual ~MyFirstService_divide_args() throw();
  double number1;
  double number2;

  _MyFirstService_divide_args__isset __isset;

  void __set_number1(const double val);

  void __set_number2(const double val);

  bool operator == (const MyFirstService_divide_args & rhs) const
  {
    if (!(number1 == rhs.number1))
      return false;
    if (!(number2 == rhs.number2))
  ...
  bool operator < (const MyFirstService_divide_args & ) const;
...
class MyFirstService_divide_pargs {
 public:


  virtual ~MyFirstService_divide_pargs() throw();
...
typedef struct _MyFirstService_divide_result__isset {
  _MyFirstService_divide_result__isset() : success(false), zero_error(false), type_error(false) {}
  bool success :1;
  bool zero_error :1;
  bool type_error :1;
} _MyFirstService_divide_result__isset;

class MyFirstService_divide_result {
 public:

  MyFirstService_divide_result(const MyFirstService_divide_result&);
  MyFirstService_divide_result& operator=(const MyFirstService_divide_result&);
  MyFirstService_divide_result() : success(0) {
  }

  virtual ~MyFirstService_divide_result() throw();
  double success;
  DivisionByZeroError zero_error;
  WrongTypeError type_error;

  _MyFirstService_divide_result__isset __isset;

  void __set_success(const double val);

  void __set_zero_error(const DivisionByZeroError& val);

  void __set_type_error(const WrongTypeError& val);

  bool operator == (const MyFirstService_divide_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(zero_error == rhs.zero_error))
      return false;
    if (!(type_error == rhs.type_error))
      return false;
    return true;
  }
  bool operator != (const MyFirstService_divide_result &rhs) const {
  ...
  bool operator < (const MyFirstService_divide_result & ) const;
...
typedef struct _MyFirstService_divide_presult__isset {
  _MyFirstService_divide_presult__isset() : success(false), zero_error(false), type_error(false) {}
  bool success :1;
  bool zero_error :1;
  bool type_error :1;
} _MyFirstService_divide_presult__isset;

class MyFirstService_divide_presult {
 public:


  virtual ~MyFirstService_divide_presult() throw();
  double* success;
  DivisionByZeroError zero_error;
  WrongTypeError type_error;

  _MyFirstService_divide_presult__isset __isset;
...
class MyFirstServiceClientT : virtual public MyFirstServiceIf {
 ...
 public:
  ...
  int recv_multiply();
  double divide(const double number1, const double number2);
  void send_divide(const double number1, const double number2);
  double recv_divide();
  int get_log_size(const std::string& filename);
...
class MyFirstServiceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 private:
  ...
  void process_divide(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext);
 ...
 public:
  MyFirstServiceProcessorT(boost::shared_ptr<MyFirstServiceIf> iface) :
    ...
    processMap_["multiply"] = ProcessFunctions(
      ...
      &MyFirstServiceProcessorT::process_multiply);
    processMap_["divide"] = ProcessFunctions(
      &MyFirstServiceProcessorT::process_divide,
      &MyFirstServiceProcessorT::process_divide);
...
class MyFirstServiceMultiface : virtual public MyFirstServiceIf {
 ...
 public:
  ...
  double divide(const double number1, const double number2) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->divide(number1, number2);
    }
    return ifaces_[i]->divide(number1, number2);
  }
...
class MyFirstServiceConcurrentClientT : virtual public MyFirstServiceIf {
 ...
 public:
  ...
  double divide(const double number1, const double number2);
  int32_t send_divide(const double number1, const double number2);
