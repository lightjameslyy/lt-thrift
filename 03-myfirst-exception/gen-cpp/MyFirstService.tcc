...
template <class Protocol_>
uint32_t MyFirstService_divide_args::read(Protocol_* iprot) {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_DOUBLE) {
          xfer += iprot->readDouble(this->number1);
          this->__isset.number1 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_DOUBLE) {
          xfer += iprot->readDouble(this->number2);
          this->__isset.number2 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
template <class Protocol_>
uint32_t MyFirstService_divide_args::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MyFirstService_divide_args");

  xfer += oprot->writeFieldBegin("number1", ::apache::thrift::protocol::T_DOUBLE, 1);
  xfer += oprot->writeDouble(this->number1);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("number2", ::apache::thrift::protocol::T_DOUBLE, 2);
  xfer += oprot->writeDouble(this->number2);
  xfer += oprot->writeFieldEnd();
...
template <class Protocol_>
uint32_t MyFirstService_divide_pargs::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MyFirstService_divide_pargs");
...
template <class Protocol_>
uint32_t MyFirstService_divide_result::read(Protocol_* iprot) {
    ...
    switch (fid)
    {
      ...
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->zero_error.read(iprot);
          this->__isset.zero_error = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->type_error.read(iprot);
          this->__isset.type_error = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
template <class Protocol_>
uint32_t MyFirstService_divide_result::write(Protocol_* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("MyFirstService_divide_result");

  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_DOUBLE, 0);
    xfer += oprot->writeDouble(this->success);
    xfer += oprot->writeFieldEnd();
  } else if (this->__isset.zero_error) {
    xfer += oprot->writeFieldBegin("zero_error", ::apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->zero_error.write(oprot);
    xfer += oprot->writeFieldEnd();
  } else if (this->__isset.type_error) {
    xfer += oprot->writeFieldBegin("type_error", ::apache::thrift::protocol::T_STRUCT, 2);
    xfer += this->type_error.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
template <class Protocol_>
uint32_t MyFirstService_divide_presult::read(Protocol_* iprot) {
...
template <class Protocol_>
double MyFirstServiceClientT<Protocol_>::divide(const double number1, const double number2)
{
...
template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::send_divide(const double number1, const double number2)
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("divide", ::apache::thrift::protocol::T_CALL, cseqid);

  MyFirstService_divide_pargs args;
  args.number1 = &number1;
  args.number2 = &number2;
  args.write(this->oprot_);
...
template <class Protocol_>
double MyFirstServiceClientT<Protocol_>::recv_divide()
{
  ...
  double _return;
  MyFirstService_divide_presult result;
  result.success = &_return;
  result.read(this->iprot_);
  this->iprot_->readMessageEnd();
  this->iprot_->getTransport()->readEnd();
  ...
  if (result.__isset.zero_error) {
    throw result.zero_error;
  }
  if (result.__isset.type_error) {
...
template <class Protocol_>
void MyFirstServiceProcessorT<Protocol_>::process_divide(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("MyFirstService.divide", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "MyFirstService.divide");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "MyFirstService.divide");
  }

  MyFirstService_divide_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "MyFirstService.divide", bytes);
  }

  MyFirstService_divide_result result;
  try {
    result.success = iface_->divide(args.number1, args.number2);
    result.__isset.success = true;
  } catch (DivisionByZeroError &zero_error) {
    result.zero_error = zero_error;
    result.__isset.zero_error = true;
  } catch (WrongTypeError &type_error) {
    result.type_error = type_error;
    result.__isset.type_error = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "MyFirstService.divide");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "MyFirstService.divide");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "MyFirstService.divide", bytes);
  }
}

template <class Protocol_>
void MyFirstServiceProcessorT<Protocol_>::process_divide(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("MyFirstService.divide", callContext);
...
template <class Protocol_>
double MyFirstServiceConcurrentClientT<Protocol_>::divide(const double number1, const double number2)
{
  int32_t seqid = send_divide(number1, number2);
  return recv_divide(seqid);
}

template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::send_divide(const double number1, const double number2)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  this->oprot_->writeMessageBegin("divide", ::apache::thrift::protocol::T_CALL, cseqid);
...
template <class Protocol_>
double MyFirstServiceConcurrentClientT<Protocol_>::recv_divide(const int32_t seqid)
{
