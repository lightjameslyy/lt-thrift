...
template <class Protocol_>
uint32_t DivisionByZeroError::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t DivisionByZeroError::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DivisionByZeroError");
...
template <class Protocol_>
uint32_t WrongTypeError::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t WrongTypeError::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("WrongTypeError");
